...
// The CourseItemFunc type is an adapter to allow the use of ordinary
// function as CourseItem mutator.
type CourseItemFunc func(context.Context, *ent.CourseItemMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CourseItemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CourseItemMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CourseItemMutation", m)
	}
	return f(ctx, mv)
}
...
// The SubjectTypeFunc type is an adapter to allow the use of ordinary
// function as SubjectType mutator.
type SubjectTypeFunc func(context.Context, *ent.SubjectTypeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SubjectTypeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.SubjectTypeMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SubjectTypeMutation", m)
	}
	return f(ctx, mv)
}
