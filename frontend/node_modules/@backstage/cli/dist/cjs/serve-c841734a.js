...
var server = require('./server-2eb660f6.js');

var serve = async (cmd) => {
  var _a, _b;
  const appConfigs = await configLoader.loadConfig({
    env: (_b = (_a = process.env.APP_ENV) != null ? _a : process.env.NODE_ENV) != null ? _b : "development",
...
//# sourceMappingURL=serve-c841734a.js.map
